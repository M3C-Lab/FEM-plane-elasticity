function poly = TriBasis(i, der_x, der_y, x, y, phys2rst)
...
if i == 1
    ...
    elseif der_x == 0 && der_y == 1
        ...
        disp("TriBasis: Please input appropriate 'der' groups.")
    end
...
elseif i == 3
    ...
    disp("TriBasis: Please input appropriate 'i'(the node number).")
end
